...
### Contatos
  ...
  <a href = "https://github.com/ste-fa-nie" target="_blank"><img src="https://img.shields.io/badge/github-%23121011.svg?style=for-the-badge&logo=github&logoColor=white" target="_blank"></a>
...
Neste projeto fiquei responsável pela parte da raspagem de dados, ou seja, no desenvolvimento de um programa que extraísse informações listadas em sites externos e armazenasse essas informações num arquivo CSV.
 ...
 <details><summary>Codigo da Raspagem de dados</summary> 
 </br>
O código Python busca informações sobre cursos na página web BNE. Ele acessa o HTML da página usando a biblioteca requests e analisa o conteúdo com BeautifulSoup. Em seguida, extrai detalhes como título, link, salário e detalhes da vaga. Os dados são organizados em linhas e escritos em um arquivo CSV.
 </br>
